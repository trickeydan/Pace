    ...
    <table class="layout layout--no-gutter" style="border-collapse: collapse;table-layout: fixed;Margin-left: auto;Margin-right: auto;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #fafafa;" align="center">
        <tbody><tr>
            <td class="column" style="padding: 0;text-align: left;vertical-align: top;color: #595959;font-size: 14px;line-height: 21px;font-family: Lato,Tahoma,sans-serif;width: 600px;">
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
                    <p style="Margin-top: 0;Margin-bottom: 20px;text-align: center;">As well as the Tutor Group Challenge and other competitions.</p>
                </div>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
                    <p style="Margin-top: 0;Margin-bottom: 20px;">To login, go to <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #6b7489;" href="https://klbschool.net">klbschool.net</a>, enter your school email address and the PIN number listed below.</p>
                </div>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                    ...
                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #595959;font-size: 20px;line-height: 28px;text-align: center;">PIN : {{$user->id}}</h2>
                </div>
