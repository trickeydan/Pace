        ...
        <tbody><tr>
            <td class="column" style="padding: 0;text-align: left;vertical-align: top;color: #595959;font-size: 14px;line-height: 21px;font-family: Lato,Tahoma,sans-serif;width: 600px;">
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
                    <p style="Margin-top: 0;Margin-bottom: 20px;">To login, go to <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #6b7489;" href="https://klbschool.net">klbschool.net</a>, enter your school email address and the PIN (Password) listed below.</p>
                </div>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                    <p style="Margin-top: 0;Margin-bottom: 20px;">Please ensure that you change your password after logging in.</p>
                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #595959;font-size: 20px;line-height: 28px;text-align: center;">EMAIL : {{$user->email}}</h2>
                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #595959;font-size: 20px;line-height: 28px;text-align: center;">PIN (Password) : klbteacher{{strtoupper($user->initials)}}</h2>
                </div>
    ...
    <table class="footer" style="border-collapse: collapse;table-layout: fixed;Margin-right: auto;Margin-left: auto;border-spacing: 0;width: 560px;" align="center">
        <tbody><tr>
            <td style="padding: 0 0 40px 0;">
                ...
                <table class="footer__left" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;width: 380px;">
                    <tbody><tr>
